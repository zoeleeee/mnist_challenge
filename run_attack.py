...
def run_attack(checkpoint, config):#x_adv, config):#epsilon, permutation_path, nb_labels):
...
#      print(y_batch.shape, y_adv_pred_batch.shape, y_nat_pred_batch.shape)
      ...
      amt += np.sum(y_nat_pred_batch == y_nat_batch)
